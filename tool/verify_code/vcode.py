...
IMAGE_VERIFY_TAIL = "_image"
IMAGE_SEND_COUNT_TAIL = "_sendcount"

IMAGE_VERIFY_EXPIRE = 15 * 60
...
def main():
    ...
    try:
        strs, stream = image_service.generate_verify_image(key)
    except Exception, ex:
        return None
